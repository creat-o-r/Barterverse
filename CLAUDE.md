...
### Available on ci-cd-infrastructure branch:
- **Build Monitoring**: Proactive health checking and auto-fixing
- **GitHub Issues Workflow**: Automated issue management and branch creation
- **Project Management**: Milestone and epic creation tools
- **Jules Branch Integration**: External branch integration automation
- **Claude Context Tools**: AI-assisted development workflow

Switch to `ci-cd-infrastructure` branch to access these tools and their documentation.
