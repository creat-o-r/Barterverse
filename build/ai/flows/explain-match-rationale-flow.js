...
exports.explainMatchRationale = explainMatchRationale;
/**
...
const ItemDetailSchema = genkit_2.z.object({
...
const ExplainMatchRationaleInputSchema = genkit_2.z.object({
...
const ExplainMatchRationaleOutputSchema = genkit_2.z.object({
    rationale: genkit_2.z.string().describe("The AI-generated explanation for why these items might be a good match for a trade, including any reciprocal benefits from Item C if provided."),
    errorMessage: genkit_2.z.string().optional().describe("An error message if rationale generation failed."),
});
async function explainMatchRationale(input) {
...
const prompt = genkit_1.ai.definePrompt({
    ...
    output: { schema: genkit_2.z.object({ rationale: genkit_2.z.string() }) },
...
const explainMatchRationaleFlow = genkit_1.ai.defineFlow({
    ...
    const processedInput = {
        itemA: Object.assign(Object.assign({}, input.itemA), { isGiftItForward: input.itemA.isGiftItForward || false }),
        itemB: Object.assign(Object.assign({}, input.itemB), { isGiftItForward: input.itemB.isGiftItForward || false }),
        itemC: input.itemC ? Object.assign(Object.assign({}, input.itemC), { isGiftItForward: input.itemC.isGiftItForward || false }) : undefined,
    };
    try {
