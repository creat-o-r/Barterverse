...
export const AuthProvider = ({ children }: { children: ReactNode }) => {
  ...
  // Placeholder functions for social auth (to be implemented later)
  const signInWithFacebook = async () => {
    throw new Error("Facebook sign-in not implemented yet");
  };

  const signInWithX = async () => {
    throw new Error("X sign-in not implemented yet");
  };
  ...
  const value = firebaseAuthInstance ? {
    ...
    signInWithFacebook: async () => { throw new Error("Auth not initialized"); },
    signInWithX: async () => { throw new Error("Auth not initialized"); },
  };
