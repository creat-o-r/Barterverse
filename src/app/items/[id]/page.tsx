...
import { MessageSquare, Star, UserCircle, Tag, Info, Repeat, Gift, Search, HelpingHand, Settings, Link2 as LinkIcon } from 'lucide-react'; // Renamed Link2 to LinkIcon
...
import TemporaryAdminMatchTestPanelClient from '@/components/items/TemporaryAdminMatchTestPanelClient'; // Import the client component
