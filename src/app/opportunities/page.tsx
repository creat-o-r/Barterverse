...
function OpportunityMatchPageContent() {
  ...
  const handleReportScore = async () => {
    ...
    try {
      ...
      const result = await logFeedbackEntry({ feedbackType: 'match-score', reportedValue: matchScore, mainItemId: mainItemIdQuery, suggestedItemId: suggestedItemIdQuery, reportingUserId: currentAuthUserId, modelUsedContext: modelUsedForContext });
  ...
  const handleReportReasoning = async () => {
    ...
    try {
      const modelUsedForContext = await getPreferredAIModel();
      const result = await logFeedbackEntry({ feedbackType: 'match-reasoning', reportedValue: opportunityReasoning, mainItemId: mainItemIdQuery, suggestedItemId: suggestedItemIdQuery, reportingUserId: currentAuthUserId, modelUsedContext: modelUsedForContext });
